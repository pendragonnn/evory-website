<x-app-layout>
  <div class="w-full bg-gray-100 min-h-screen pb-20">
    ...
    <div class="w-full h-64 sm:h-80 lg:h-[420px] overflow-hidden">
      @if ($event->cover)
        <img src="{{ asset($event->cover) }}" class="w-full h-full object-cover">
      @else
    ...
    @if ($event->event_booth_map)
      <section class="px-6 sm:px-12 lg:px-24">
        ...
        <div class="w-full bg-gray-200 rounded-lg overflow-hidden">
          <img src="{{ asset($event->event_booth_map) }}" class="w-full h-auto object-contain">
        </div>
      </section>
    @endif
    ...
    <section class="px-6 sm:px-12 lg:px-24 mt-10 mb-6">
      ...
      <div class="flex gap-4 text-sm items-center">
        ...
        <div class="flex items-center gap-1">
          <div class="w-4 h-4 bg-gray-300 border-gray-500"></div>
          <span>Booked</span>
        </div>
      </div>
    </section>
    ...
    <section class="px-6 sm:px-12 lg:px-24 mt-8">
        ...
        @php
          function booth_color($status)
          {
            return match ($status) {
              ...
              'booked' => 'bg-gray-300 border-gray-500',
